...
# Generation Time: 2014-06-20 21:45:51 +0000
# ************************************************************
...
CREATE TABLE `flux_MonitorTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) DEFAULT NULL,
  `decay_constant` double DEFAULT NULL,
  `decay_constant_err` double DEFAULT NULL,
  `age` double DEFAULT NULL,
  `age_err` double DEFAULT NULL,
...
CREATE TABLE `gen_SampleTable` (
  ...
  `environment` varchar(140) DEFAULT NULL,
  `rock_type` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `irrad_IrradiationTable` (
  ...
  CONSTRAINT `irrad_irradiationtable_ibfk_3` FOREIGN KEY (`reactor_id`) REFERENCES `irrad_ReactorTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `irrad_ProductionTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) DEFAULT NULL,
  `K4039` double DEFAULT NULL,
  `K4039_err` double DEFAULT NULL,
  `K3839` double DEFAULT NULL,
  `K3839_err` double DEFAULT NULL,
  `K3739` double DEFAULT NULL,
  `K3739_err` double DEFAULT NULL,
  `Ca3937` double DEFAULT NULL,
  `Ca3937_err` double DEFAULT NULL,
  `Ca3837` double DEFAULT NULL,
  `Ca3837_err` double DEFAULT NULL,
  `Ca3637` double DEFAULT NULL,
  `Ca3637_err` double DEFAULT NULL,
  `Cl3638` double DEFAULT NULL,
  `Cl3638_err` double DEFAULT NULL,
...
# Dump of table irrad_ReactorTable
# ------------------------------------------------------------

CREATE TABLE `irrad_ReactorTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) DEFAULT NULL,
  `address` varchar(180) DEFAULT NULL,
  `reactor_type` varchar(80) DEFAULT NULL,
  `note` blob,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `meas_MeasurementTable` (
  ...
  `script_id` int(11) DEFAULT NULL,
  `time_zero_offset` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `mass_spectrometer_id` (`mass_spectrometer_id`),
...
# Dump of table proc_AnalysisGroupSetTable
# ------------------------------------------------------------

CREATE TABLE `proc_AnalysisGroupSetTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `analysis_id` (`analysis_id`),
  KEY `analysis_type_id` (`analysis_type_id`),
  CONSTRAINT `proc_analysisgroupsettable_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `proc_AnalysisGroupTable` (`id`),
  CONSTRAINT `proc_analysisgroupsettable_ibfk_2` FOREIGN KEY (`analysis_id`) REFERENCES `meas_AnalysisTable` (`id`),
  CONSTRAINT `proc_analysisgroupsettable_ibfk_3` FOREIGN KEY (`analysis_type_id`) REFERENCES `gen_AnalysisTypeTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;



# Dump of table proc_AnalysisGroupTable
# ------------------------------------------------------------

CREATE TABLE `proc_AnalysisGroupTable` (
...
CREATE TABLE `proc_ArArTable` (
  ...
  `age` double DEFAULT NULL,
  `age_err` double DEFAULT NULL,
  `age_err_wo_j` double DEFAULT NULL,
  `k39` double DEFAULT NULL,
  `k39_err` double DEFAULT NULL,
  `ca37` double DEFAULT NULL,
  `ca37_err` double DEFAULT NULL,
  `cl36` double DEFAULT NULL,
  `cl36_err` double DEFAULT NULL,
  `Ar40` double DEFAULT NULL,
  `Ar40_err` double DEFAULT NULL,
  `Ar39` double DEFAULT NULL,
  `Ar39_err` double DEFAULT NULL,
  `Ar38` double DEFAULT NULL,
  `Ar38_err` double DEFAULT NULL,
  `Ar37` double DEFAULT NULL,
  `Ar37_err` double DEFAULT NULL,
  `Ar36` double DEFAULT NULL,
  `Ar36_err` double DEFAULT NULL,
  `rad40` double DEFAULT NULL,
  `rad40_err` double DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `history_id` (`history_id`),
...
CREATE TABLE `proc_BlanksTable` (
  ...
  `set_id` int(11) DEFAULT NULL,
  `error_type` varchar(40) DEFAULT NULL,
  `preceding_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `history_id` (`history_id`),
  KEY `preceding_id` (`preceding_id`),
  CONSTRAINT `proc_blankstable_ibfk_1` FOREIGN KEY (`history_id`) REFERENCES `proc_BlanksHistoryTable` (`id`),
  CONSTRAINT `proc_blankstable_ibfk_2` FOREIGN KEY (`preceding_id`) REFERENCES `meas_AnalysisTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `proc_DetectorParamTable` (
  ...
  `disc_error` double DEFAULT NULL,
  `detector_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `history_id` (`history_id`),
  KEY `detector_id` (`detector_id`),
...
CREATE TABLE `proc_FitTable` (
  ...
  `error_type` varchar(40) DEFAULT NULL,
  `include_baseline_error` tinyint(1) DEFAULT NULL,
  `time_zero_offset` float DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `history_id` (`history_id`),
  KEY `isotope_id` (`isotope_id`),
...
# Dump of table spec_MFTableTable
# ------------------------------------------------------------

CREATE TABLE `spec_MFTableTable` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_date` datetime DEFAULT NULL,
  `blob` blob,
  `spectrometer_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `spectrometer_id` (`spectrometer_id`),
  CONSTRAINT `spec_mftabletable_ibfk_1` FOREIGN KEY (`spectrometer_id`) REFERENCES `gen_MassSpectrometerTable` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
